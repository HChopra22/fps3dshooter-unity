...
//OneTapGun is the logic behind Guns that are not automatic in the game, it however uses the same logic as Auto guns
public class OneTapGun : MonoBehaviour
{
    [Header("Damage Variables")]
    public float damage = 10f;
    public float range = 100f;
    public float timeBetweenShot = 15f;
   ...
   //At the start, make sure the guns ammo is full
    ...
    /*shoot handles the raycast logic behind the guns. When one click occurs one shot is called
    ...
    //if a shot is in the zombies range, change the zombies state from wander to aware.
